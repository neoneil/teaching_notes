...
// import rootsData from "../TableComponent/Roots";
// import Emailjs from "../Emailjs/emailjs";
// import Pte from "../PTEsyllabus/Pte";
import Aboutme from "../AboutMe/Aboutme"
// import Table from "../TableComponent/Table";
const Home = () => {

    // const [roots] = useState([...rootsData]);
    return (
        <div className="container">
                    <Aboutme />
            {/* <div className="row">
                <div className="col-7 yellow">
                    <Pte />
                </div>
                <div className="col-5 changeMargin">
                    <Emailjs />
                </div>
            </div> */}
            ...
            {/* <div className="col">
                <Table data={roots} rowsPerPage={10} />
            </div> */}
        </div>
    );
